    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for ( int i = 0; i < childCount; i++ ) {
            ...
            if ( mCallback != null ) {
                ...
                Log.d("StickySectionDecoration","onDrawOver---------i:"+i);
...
//                        Log.d("StickySectionDecoration","onDrawOver-----if----top:"+top);
...
//                    Log.d("StickySectionDecoration","onDrawOver-----else----top:"+top);
    ...
    private void drawHeaderRect(Canvas c, GroupInfo groupinfo, int left, int top, int right, int bottom) {
        Log.d("StickySectionDecoration","drawHeaderRect---------top:"+top);
        Log.d("StickySectionDecoration","drawHeaderRect---------bottom:"+bottom);
        //绘制Header
