...
public class PermissionUtils {
    ...
    public static String[] PERMISIONS_LOCATION = {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};
