...
import com.example.knowledge.image.maskfilter.MaskFilterActivity;
...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_mask_filter).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_slim_face:
                ...
                break;
            case R.id.bt_mask_filter:
                intent.setClass(ImageActivity.this, MaskFilterActivity.class);
                break;
        }
